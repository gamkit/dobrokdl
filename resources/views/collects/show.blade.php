...
<main class="page page-collect">
      ...
      <h3>Сбор № {{ $collect->id }} {{ $collect->quickly_collect }}</h3>
      <!-- SECTION-->
            ...
            <div class="collect-box__collect-info-item collect-item {{ $collect_done }} {{ $collect_urgent }}">
              <div class="row-mg">
                ...
                <div class="collect-item__desc">
                  <h4 class="collect-item__name"><b>{{ $collect->fullname }}</b>, {{ $collect->year }} лет</h4>
                  ...
                  <div class="collect-item__collect row">
                    ...
                    <p class="collect-item__needed">Требуется <br/><b>{{ $collect->needed_money }} р.</b></p>
